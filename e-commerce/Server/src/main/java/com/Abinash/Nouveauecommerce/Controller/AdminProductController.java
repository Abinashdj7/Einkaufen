...
public class AdminProductController {
	...
	@PostMapping("/creates")
	public ResponseEntity<String> createMultipleProduct(@RequestBody CreateProductRequest[] reqs) throws ProductException{
		
		for(CreateProductRequest product:reqs) {
			productService.createProduct(product);
		}
		
		String res="Products created successfully";
		return new ResponseEntity<String>(res,HttpStatus.ACCEPTED);
	}
