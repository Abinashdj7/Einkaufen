...
public class CartItemController {
	...
	public ResponseEntity<CartItem> changeQuantity(@PathVariable Long cartItemId,@RequestHeader("Authorization") String jwt,@RequestBody Integer changeNumber) throws CartItemException, UserException {
			User user=userService.findUserProfileByJwt(jwt);
			CartItem updatedCartItem=cartItemService.changeNumberOfItems(user.getId(),cartItemId,changeNumber);
