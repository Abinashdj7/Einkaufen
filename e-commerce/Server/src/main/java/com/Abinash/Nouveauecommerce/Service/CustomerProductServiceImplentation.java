...
public class CustomerProductServiceImplentation implements ProductService {
	...
	private static final Logger logger = LoggerFactory.getLogger(CustomerProductServiceImplentation.class);
	...
	public List<Product> getProductTrue(String levelOneCategory, String levelTwoCategory, String levelThreeCategory) {
		...
		List<Product> products = productRepo.getProductsByCategory(levelOneCategory, levelTwoCategory,
				levelThreeCategory);
		return products;
	}
}
